...
void createZeroSizedRelationForward();
void createNonConsecutiveRelation();
void intTestsEmptyTree();
void intTests();
void intNonintNonConTests();
void intNonConTests();
void indexNonConsecutiveTests();
...
void test5() { 
  ...
  createZeroSizedRelationForward();
  indexEmptyTests();
  deleteRelation();
  std::cout << "\nTest 5 passed\n" << std::endl;
}
...
void test6() {
  ...
  // on attribute of type int 
  std::cout << "--------------------" << std::endl;
  std::cout << "Test for out of bounds rels" << std::endl;
  createRelationForward();
...
void test7(){
  // Create a relation with tuples valued 0 to 2*relationSize with non-consecutive records and perform index tests
  // on attribute of type int 
  std::cout << "--------------------" << std::endl;
  std::cout << "CreateRelationNonconsecutive" << std::endl;
  createNonConsecutiveRelation();
  indexNonConsecutiveTests();
  deleteRelation();
  std::cout << "\nTest 7 passed\n" << std::endl;
}

// -----------------------------------------------------------------------------
// createNonConsecutiveRelationForward
// -----------------------------------------------------------------------------
void createNonConsecutiveRelation()
{
